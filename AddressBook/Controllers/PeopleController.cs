...
namespace AddressBook.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonId,FirstName,LasttName,Email")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonId,FirstName,LasttName,Email")] Person person)
        {
